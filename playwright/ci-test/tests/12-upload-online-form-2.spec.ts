...
test.describe('navigation', () => {
  ...
  test('Add property data', async ({ page }) => {
    ...
    await page.getByLabel('Adult Males', { exact: true }).fill('16');
    await page.getByLabel('Adult Females', { exact: true }).click();
    await page.getByLabel('Adult Females', { exact: true }).fill('14');
    await page.getByLabel('Subadult Males').click();
    await page.getByLabel('Subadult Males').fill('14');
    await page.getByLabel('Subadult Females').click();
    await page.getByLabel('Subadult Females').fill('10');
    await page.getByLabel('Juvenile Males').click();
    await page.getByLabel('Juvenile Males').fill('16');
    await page.getByLabel('Juvenile Females').click();
    await page.getByLabel('Juvenile Females').fill('08');
    ...
    await page.locator('#intake_adult_male').fill('02');
    ...
    await page.locator('#intake_juvenile_male').fill('01');
    await page.locator('#intake_juvenile_female').fill('03');
    ...
    await page.locator('#offtake_adult_female').fill('02');
    await page.locator('#offtake_juvenile_male').click();
    await page.locator('#offtake_juvenile_female').click();
    await page.locator('#offtake_juvenile_female').fill('02');
