...
class NatureOfPopulationTestCase(TestCase):
    ...
    def test_create_nature_of_population(self):
        ...
        self.assertTrue(isinstance(self.nature_of_population, NatureOfPopulation))
        self.assertEqual(NatureOfPopulation.objects.count(), 1)
        self.assertEqual(self.nature_of_population.name, 'nature of population-0')
    ...
    def test_update_nature_of_population(self):
        ...
        self.assertEqual(NatureOfPopulation.objects.get(id=1).name, 'nature of population-1')
