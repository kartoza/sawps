...
class DataUsePermissionTestCase(TestCase):
    ...
    def setUpTestData(cls):
        """ setup test data """
        cls.data_use_permission =  regulatoryPermitFactories.DataUsePermissionFactory()

    def test_create_data_use_permission(self):
        """ test creating use permission """
        self.assertTrue(isinstance(self.data_use_permission, regulatoryPermitModels.DataUsePermission))
    ...
    def test_update_data_use_permission(self):
        ...
        self.data_use_permission.description = 'Data Use Permission Description #1'
        self.data_use_permission.save()
        self.assertEqual(regulatoryPermitModels.DataUsePermission.objects.get(id=1).name,
                         "Data Use Permission #1")
        self.assertEqual(regulatoryPermitModels.DataUsePermission.objects.get(id=1).description,
                         "Data Use Permission Description #1")
    
    def test_unqiue_data_use_permission_name(self):
        """ test unique name of use permission """
        try:
            data_use_permission = (regulatoryPermitModels.DataUsePermission
            .objects.create(
