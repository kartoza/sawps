...
export default function Step1(props: Step1Interface) {
    ...
    return (
        <Grid container className='UploadSection' spacing={2}>
            ...
            <Grid item className='UploadSectionContent Property'>
                <Grid container flexDirection={'column'} spacing={2}>
                    ...
                    <Grid item>
                        <PropertyInfo property={property} enableForm={true}
                    ...
                    <Grid item className='ButtonContainer'>
                        <Button variant='contained' onClick={onSaveProperty}>SAVE PROPERTY INFORMATION</Button>
                    </Grid>
                </Grid>
            </Grid>
            <Grid item>
