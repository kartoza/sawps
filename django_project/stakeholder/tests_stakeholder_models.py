...
class UserTitleTestCase(TestCase):
    ...
    def test_update_title(self):
        ...
        userTitle = stakholderModels.UserTitle.objects.get(id=self.userTitle.id)
...
class TestUserRoleType(TestCase):
    ...
    def test_create_new_role(self):
        ...
        self.assertTrue(self.UserRoleTypeFactory.name in ['base user', 'admin', 'super user'])

    def test_update_role(self):
        """ test updating a role """
        self.UserRoleTypeFactory.name="admin"
        self.UserRoleTypeFactory.save()
        UserRoleObject = stakholderModels.UserRoleType.objects.get(id=self.UserRoleTypeFactory.id)
...
class TestUser(TestCase):
    ...
    def test_create_new_user_with_new_profile(self):
        ...
        self.assertEqual(User.objects.count(),2) # Anon user is created by default
    ...
    def test_update_user_profile(self):
        ...
        self.assertEqual(User.objects.get(username="test").first_name, 'test123')
