...
class userTitleFactory(factory.django.DjangoModelFactory):
    ...
    name = factory.Faker('random_element', elements=('mr', 'mrs', 'miss', 'dr'))
...
class userRoleTypeFactory(factory.django.DjangoModelFactory):
    ...
    name = factory.Faker('random_element', elements=('base user', 'admin', 'super user'))
...
class loginStatusFactory(factory.django.DjangoModelFactory):
    ...
    name = factory.Faker('random_element', elements=('logged in', 'logged out'))
...
class userFactory(factory.django.DjangoModelFactory):
    ...
    # profile = factory.RelatedFactory('stakeholder.factories.userProfileFactory')
...
class userProfileFactory(factory.django.DjangoModelFactory):
    ...
    # profile = None is described here https://factoryboy.readthedocs.io/en/stable/recipes.html#example-django-s-profile
    ...
    user_role_type_id = factory.SubFactory('stakeholder.factories.userRoleTypeFactory')
...
class userLoginFactory(factory.django.DjangoModelFactory):
    ...
    login_status_id = factory.SubFactory('stakeholder.factories.loginStatusFactory')
